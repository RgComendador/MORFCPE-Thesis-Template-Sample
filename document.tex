...
\newcommand{\documentAdviser}{Melvin Kong Cabatuan}

\newcommand{\examinerChairTitle}{Dr.} 
\newcommand{\examinerChair}{Roderick Yap}

% Sort in alphabetically ascending manner the surnames of the examiners
\newcommand{\examinerATitle}{Dr.} 
\newcommand{\examinerA}{Donabel de Veas-Abuan}

\newcommand{\examinerBTitle}{Dr.} 
\newcommand{\examinerB}{Jay Robert del Rosario}
...
\defineAuthor{surname3}{Fallar}
\defineAuthor{firstname3}{Mac Excel S.}

\defineAuthor{surname4}{Garcia}
\defineAuthor{firstname4}{Laureen Audrey R.}

\defineAuthor{surname5}{Lerit}
\defineAuthor{firstname5}{Jose Mari Luis L.}

\newcommand{\documentTitle}{DI PA NAMIN ALAM TITLE} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{EWAN, KO}
